 ...
 *
 * Dogfood routes use `requireModule` / org grants, not these helpers.
 */
...
/**
 * @deprecated Use `requireModule` / org grants for request-path authz.
 * Kept as a pure system-role matrix for products without Phase B grants.
 */
