...
1. Read [`start-product.md`](./start-product.md) remotes + zero-edit. When `apps/<product>-api` exists, run `bash scripts/kit/kit-schema-sync.sh --app apps/<product>-api` ([`docs/kit/kit-schema-sync.md`](../kit-schema-sync.md)).
...
6. DoD: kit `validate:full` + product-validate templates under `docs/kit/templates/`.
