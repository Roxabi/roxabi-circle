...
Do **not** add Paraglide, **L2** patchlog package, default Plausible, or TanStack Start-as-API without meeting unpark criteria **and** a new ADR/goal. **L1** in-app changelog recipe (`docs/kit/recipes/changelog-l1.md`, `example-web`) is allowed. Unpark L2 = intentional, not FOMO.
