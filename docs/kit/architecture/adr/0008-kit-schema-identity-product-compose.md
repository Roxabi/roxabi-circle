...
> **Amendment (2026-08-24):** [ADR-0012](./0012-kernel-persistence-request-context.md) is this follow-up. It promotes **applied** kit-generic bytes as persist SSoT and discards drifted package sketches. This section is not rewritten.
