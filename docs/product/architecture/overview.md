...
2. Gateway : enforce `#github-to-watch` + `#news-actu` + `@Lyra` mention forward + repo-digest webhook — **live**
...
| `/apply`, appeal tickets | `#github-to-watch` / `#news-actu` MESSAGE_CREATE · `@Lyra` → Grok webhook · repo URL → digest webhook |
