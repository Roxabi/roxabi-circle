...
# Linked forms ([ADR-0002](docs/architecture/adr/...)) are OK.
...
echo "" >&2
echo "${TAG}: $FILE has ${COUNT} line(s) with bare ADR-NNN (prefer domain link or [ADR-N](docs/...)):" >&2
echo "$BARE" >&2
echo "" >&2
echo "See docs/debt-tracking.md § AGENTS.md ADR hygiene." >&2
