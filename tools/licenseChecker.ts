/**
 * License Checker — Dependency License Compliance (Chemin A kit)
 *
 * Scans monorepo dependencies (Bun node_modules / .bun), checks licenses against
 * `.license-policy.json`, writes `reports/licenses.json`.
 *
