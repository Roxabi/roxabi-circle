...
| Product fork, upstream sync, zero-edit or schema composition | [`docs/kit/product-consumer-contract.md`](docs/kit/product-consumer-contract.md) and [`docs/kit/kit-schema-sync.md`](docs/kit/kit-schema-sync.md) |
