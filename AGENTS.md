...
| `@kit/auth` | Better Auth `createBetterAuth` factory + SessionPort + API keys `sk_` + org-role helpers ([ADR-0002](docs/architecture/adr/0002-session-hmac-interim-vs-better-auth.md) BA-only · [ADR-0003](docs/architecture/adr/0003-multi-tenant-rbac-modules.md) · [ADR-0008](docs/architecture/adr/0008-kit-schema-identity-product-compose.md) D6) | **P0** |
